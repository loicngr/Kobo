export default {
  'tours.settings.skills.title': 'Eine Skill-Suite wählen',
  'tours.settings.skills.description':
    'Beginnen Sie mit Standard: keine Erweiterung nötig. Superpowers, gstack, ECC und Kombinationen verwenden Skills, die bereits installiert und für die gewählte Engine verfügbar sind. Die Auswahl ändert Agentenanweisungen; sie installiert keine Skills und erteilt keine Berechtigungen. Benutzerdefiniert erlaubt eigene Anweisungen. Speichern Sie Ihre Auswahl.',
  'tours.settings.git.description':
    'Legen Sie fest, wann Agenten committen, pushen oder veröffentlichen dürfen. Konfigurieren Sie Git-Konventionen und Branch-Präfixe.',
  'tours.settings.git.title': 'Git-Workflow',
  'settings.reviewPromptHint': 'Anweisungen an den Agenten beim Start einer Code-Review.',
  'settings.help.git': 'Einstellungen für Commits, Push und Veröffentlichung, Git-Konventionen und Branch-Präfixe.',
  'settings.nav.promptTemplates': 'Prompt-Vorlagen',
  'settings.nav.git': 'Git',
  'integration.direct': 'Direkte Verbindung',
  'integration.directHint':
    'Optional: Konfigurieren Sie einen vertrauenswürdigen MCP-Befehl auf diesem Server ohne Claude-Konfiguration. Zugangsdaten gehören in Umgebungsvariablen. Speichern ersetzt die gesamte Verbindung; aktivieren Sie die Integration separat.',
  'integration.agentScope':
    'Aktivierte Verbindungen werden Claude Code und Codex beim nächsten Start oder Fortsetzen übergeben. Stoppen Sie laufende Agenten, um Änderungen anzuwenden. Persönliche MCP-Konfigurationen bleiben unabhängig.',
  'integration.directOverrides':
    'Die gespeicherte direkte Verbindung hat Vorrang. Entfernen Sie sie, um einen Claude-MCP-Eintrag zu verwenden.',
  'integration.stored': 'Eine private Verbindung ist gespeichert. Ihre Werte werden nie an den Browser zurückgegeben.',
  'integration.example': 'Beispiel: {example}',
  'integration.tokenExample': 'IHR_NOTION_TOKEN',
  'integration.packageExample': 'ihr-mcp-paket',
  'integration.variableExample': 'IHRE_VARIABLE',
  'integration.valueExample': 'ihr-wert',
  'integration.command': 'Programm',
  'integration.args': 'Argumente (JSON-Array)',
  'integration.environment': 'Umgebung und Zugangsdaten (JSON-Objekt)',
  'integration.failed':
    'Verbindung konnte nicht geladen oder gespeichert werden. Prüfen Sie JSON und lokalen Speicher.',
  'integration.saved': 'Verbindung gespeichert. Aktivieren Sie die Integration und testen Sie die Verbindung.',
  'integration.save': 'Verbindung ersetzen',
  'integration.clear': 'Direkte Verbindung entfernen',
  'settings.notificationSoundReady': 'Fertig-Ton',
  'settings.customSounds': 'Importierte Klänge',
  'settings.customSoundsHint':
    'Importiere eigene Benachrichtigungsklänge (max. {count}, je {size} MB, .wav .mp3 .ogg .webm). Sie werden im Kōbō-Datenverzeichnis gespeichert und erscheinen in allen Klangauswahlen unten.',
  'settings.customSoundsImport': 'Klang importieren',
  'settings.customSoundsFull': 'Grenze erreicht ({count} Klänge). Lösche einen, bevor du einen weiteren importierst.',
  'settings.customSoundsError.type': 'Nicht unterstütztes Format. Verwende eine .wav-, .mp3-, .ogg- oder .webm-Datei.',
  'settings.customSoundsError.size': 'Datei zu groß. Die Grenze liegt bei {size} MB.',
  'settings.customSoundsError.count':
    'Grenze erreicht ({count} Klänge). Lösche einen, bevor du einen weiteren importierst.',
  'settings.customSoundsError.failed': 'Aktion nicht möglich. Prüfe die Verbindung und versuche es erneut.',
  'setup.check.worktrees': 'Worktree-Verzeichnis',
  'setup.fix.worktrees': 'Prüfen Sie das Worktree-Ziel in den Einstellungen und seine Schreibrechte.',
  'setup.title': 'Erste Aufgabe einrichten',
  'setup.intro': 'Wählen Sie eine Engine und ein lokales Git-Projekt. Skills und Integrationen sind optional.',
  'setup.project': 'Lokales Projektverzeichnis',
  'setup.credentials':
    'Melden Sie sich auf diesem Server mit claude /login oder codex login an, oder konfigurieren Sie Ihren API-Schlüssel. Diese Prüfungen senden keine kostenpflichtigen Prompts.',
  'setup.permissions':
    'Beginnen Sie mit einem Plan. Wählen Sie Ausführungsrechte ausdrücklich im Erstellungsformular; ein Worktree isoliert Ihren Rechner nicht.',
  'setup.check': 'Umgebung prüfen',
  'setup.failed': 'Die Aktion ist fehlgeschlagen. Prüfen Sie die Verbindung und versuchen Sie es erneut.',
  'setup.start': 'Erste Aufgabe beschreiben',
  'setup.settings': 'Einstellungen öffnen',
  'setup.skip': 'Vorerst überspringen',
  'setup.status.ok': 'Verfügbar',
  'setup.status.missing': 'Fehlt',
  'setup.status.error': 'Prüfung nötig',
  'setup.status.unknown': 'Nicht geprüft',
  'setup.check.node': 'Node.js',
  'setup.check.platform': 'Plattform',
  'setup.check.git': 'Git',
  'setup.check.shell': 'Bash',
  'setup.check.storage': 'Datenverzeichnis',
  'setup.check.runtime': 'Engine-Paket',
  'setup.check.authentication': 'Anmeldung',
  'setup.check.model': 'Modellzugriff',
  'setup.check.repository': 'Git-Repository',
  'setup.check.firstCommit': 'Erster Commit',
  'setup.check.projectWritable': 'Schreibzugriff auf das Projekt',
  'setup.fix.node': 'Installieren Sie Node.js ab 24.15.',
  'setup.fix.platform': 'Verwenden Sie Linux, macOS oder WSL2; natives Windows wird nicht unterstützt.',
  'setup.fix.git': 'Installieren Sie Git auf diesem Server.',
  'setup.fix.shell': 'Installieren Sie Bash auf diesem Server.',
  'setup.fix.storage': 'Prüfen Sie KOBO_HOME und die Verzeichnisrechte.',
  'setup.fix.runtime': 'Installieren Sie Kōbō samt optionalen Engine-Abhängigkeiten neu.',
  'setup.fix.authentication': 'Melden Sie sich beim gewählten Anbieter an. Die erste Aufgabe prüft den Zugriff.',
  'setup.fix.model': 'Wählen Sie Auto oder ein für Ihr Konto verfügbares Modell.',
  'setup.fix.repository': 'Wählen Sie ein vorhandenes Git-Arbeitsverzeichnis.',
  'setup.fix.firstCommit': 'Erstellen Sie den ersten Commit vor dem Worktree.',
  'setup.fix.projectWritable': 'Wählen Sie ein beschreibbares Projektverzeichnis.',
  'handoff.freshTitle': 'In einer frischen Sitzung fortfahren',
  'handoff.switchTitle': 'LLM wechseln',
  'handoff.warning':
    'Die aktuelle Arbeit wird sofort unterbrochen. Eine frische Sitzung setzt automatisch im selben Workspace fort; Aufgaben und Verlauf bleiben erhalten.',
  'handoff.generate': 'Übergabe mit dem aktuellen Agenten erstellen',
  'handoff.generateHint':
    'Bei erschöpftem Kontingent deaktivieren. Kōbō übergibt Ziel, Aufgaben, Git-Status und Verlauf ohne Aufruf des aktuellen LLM.',
  'handoff.start': 'Frische Sitzung starten',
  'handoff.stopping': 'Aktuellen Agenten stoppen',
  'handoff.generating': 'Übergabe vorbereiten',
  'handoff.starting': 'Frische Sitzung starten',
  'handoff.completed': 'Frische Sitzung gestartet',
  'handoff.failed': 'Übergabe fehlgeschlagen',
  'handoff.interrupted': 'Übergabe unterbrochen',
  'handoff.cancelled': 'Übergabe abgebrochen',
  'handoff.skip': 'Ohne LLM-Zusammenfassung fortfahren',
  'handoff.cancel': 'Übergabe abbrechen',
  'handoff.report': 'Übergabe lesen',
  'handoff.source': 'Vorherige Sitzung',
  'handoff.progress': 'Sitzungsübergabe läuft',
  'handoff.blocked': 'Übergabe fortsetzen oder abbrechen, um weiterzuarbeiten.',
  'handoff.error': 'Die Sitzungsübergabe konnte nicht vorbereitet werden.',
  'handoff.loadFailed': 'Der Übergabestatus konnte nicht geladen werden.',
  'handoff.status': 'Sitzungsübergabe',
  ...
  'workspace.deleteTitle': 'Workspace löschen',
  'workspace.deleteTypeBranch': 'Branch-Namen zur Bestätigung erneut eingeben',
  'workspace.deleteConsequences': 'Dies entfernt den Worktree und den gesamten Verlauf.',
  'workspace.deleteFailed': 'Workspace konnte nicht gelöscht werden.',
  'workspace.archiveFailed': 'Workspace konnte nicht archiviert werden.',
  'tasks.updateFailed': 'Aufgabe konnte nicht aktualisiert werden.',
  'dashboard.tooltip': 'Übersicht',
  'dashboard.title': 'Übersicht',
  'dashboard.count': '{n} Workspace | {n} Workspaces',
  'dashboard.empty': 'Kein aktiver Workspace.',
  ...
  'dashboard.prOpen': 'offen',
  'reliability.title': 'Modellzuverlässigkeit',
  'reliability.subtitle': 'Wie jede Engine und jedes Modell auf diesem Rechner tatsächlich endete.',
  'reliability.empty': 'Noch keine Sitzung beendet.',
  'reliability.loadFailed': 'Die Zuverlässigkeitswerte konnten nicht geladen werden.',
  'reliability.engine': 'Engine',
  'reliability.model': 'Modell',
  'reliability.sessions': 'Sitzungen',
  'reliability.completed': 'Abgeschlossen',
  'reliability.watchdog': 'Watchdog',
  'reliability.killed': 'Gestoppt',
  'reliability.errors': 'Fehler',
  'reliability.unknown': 'Unbekannt',
  ...
  'reliability.reset': 'Zurücksetzen: nur ab jetzt beendete Sitzungen zählen',
  'reliability.since': 'Seit {date}',
  'reliability.showAll': 'Alle anzeigen',
  'update.available': 'Eine neuere Version von Kōbō ist verfügbar: {version}',
  'update.how': 'Wie aktualisieren',
  ...
  'model.mythos5Description': 'Fable 5.1 ohne Sicherheitsklassifikatoren — eingeschränkter Zugriff (Project Glasswing)',
  'model.opus': 'Opus 4.6',
  ...
  'model.sonnet5Description': 'Beste Mischung aus Geschwindigkeit und Intelligenz, 1M Kontext',
  ...
  'model.gpt56terraDescription': 'Ausgewogenes agentisches Coding-Modell für den Alltag (erfordert ChatGPT-Anmeldung)',
  'model.gpt56luna': 'GPT-5.6 Luna',
  'model.gpt56lunaDescription': 'Schnelles und günstiges agentisches Coding-Modell (erfordert ChatGPT-Anmeldung)',
  'model.gpt55': 'GPT-5.5',
  ...
  'model.gpt52': 'GPT-5.2',
  'model.gpt52Description': 'Optimiert für professionelle Arbeit und langlaufende Agenten',
  ...
  'reasoning.noneDescription': 'Ohne zusätzliches Reasoning',
  ...
  'workspaceList.a11y.groupToggle': 'Gruppe {group}, {count} Workspaces',
  ...
  'workspacePage.commandFocusChat': 'Chat-Eingabe fokussieren',
  'workspacePage.commandSearchHistory': 'Workspace-Verlauf durchsuchen',
  ...
  'workspacePage.deleteSession': 'Sitzung löschen',
  'workspacePage.deleteSessionTitle': 'Sitzung löschen?',
  'workspacePage.deleteSessionConfirm': 'Diese Sitzung und ihr Gesprächsverlauf werden dauerhaft gelöscht.',
  'workspacePage.deleteSessionFailed': 'Sitzung konnte nicht gelöscht werden',
  ...
  'workspacePage.engineHandoff': 'Übergabe für die neue Engine',
  ...
  'whip.phrase1': 'Bitte fortfahren.',
  'whip.phrase2': 'Arbeite die Aufgaben weiter ab.',
  'whip.phrase3': 'Bitte mit dem nächsten Schritt fortfahren.',
  'whip.phrase4': 'Prüfe den Fortschritt und fahre fort.',
  'whip.phrase5': 'Bleibe im vereinbarten Umfang.',
  ...
  'chatInput.commandPalette': 'Befehle',
  'chatInput.shortcuts': 'Tastenkürzel',
  ...
  'createPage.descriptionLabel': 'Aufgabenbeschreibung',
  'createPage.sources': 'Optionale Quellen',
  'createPage.sectionGit': 'Git-Projekt',
  'createPage.sectionGitHint': 'Wählen Sie Repository, Ausgangsbranch und Worktree-Modus.',
  'createPage.worktreeMode': 'Worktree-Modus',
  'createPage.worktreeNew': 'Neuer isolierter Worktree',
  'createPage.worktreeExisting': 'Vorhandenen Worktree verwenden',
  'createPage.projectLabel': 'Projekt',
  'createPage.sourceBranch': 'Ausgangsbranch',
  'createPage.workingBranchPreview': 'Vorschau des Arbeitsbranches',
  'createPage.branchNamePending': 'workspace-name',
  'createPage.sectionAgent': 'Agent',
  'createPage.sectionAgentHint': 'Prüfen Sie die Ausführungsvorgaben oder aktivieren Sie die Automatisierung.',
  'createPage.configureAgent': 'Agent konfigurieren',
  'createPage.advancedOptions': 'Erweiterte Optionen',
  'createPage.keyboardHint': 'Drücken Sie Strg/Cmd + Enter, um den Workspace zu erstellen.',
  'createPage.createWorkspace': 'Workspace erstellen',
  'createPage.compareEngines': 'Zwei Engines vergleichen',
  'createPage.engineA': 'Engine A',
  'createPage.engineB': 'Engine B',
  'createPage.compareBrainstormLocked':
    'Vergleichsmodus: jede Engine brainstormt mit dem Modell und dem Aufwand aus ihrem eigenen Block oben.',
  'createPage.compareEnginesHint':
    'Erstellt aus dieser Aufgabe zwei Workspaces, einen pro Engine, in benachbarten Worktrees. Ihre Diffs lassen sich danach nebeneinander vergleichen.',
  'createPage.compareNeedsNewWorktree':
    'Der Vergleich zweier Engines braucht zwei neue Worktrees. Schalten Sie zuerst „vorhandenen Worktree verwenden“ aus.',
  'createPage.compareNeedsSecondEngine': 'Wählen Sie eine zweite, vom ersten verschiedene Engine für den Vergleich.',
  'comparison.title': 'Engine-Vergleich',
  'comparison.hint': 'Dieselbe Aufgabe, von jeder Engine im eigenen Worktree ausgeführt.',
  'comparison.engine': 'Engine',
  'comparison.status': 'Status',
  'comparison.tasks': 'Aufgaben',
  'comparison.commits': 'Commits',
  'comparison.files': 'Dateien',
  'comparison.diff': 'Diff',
  'comparison.messages': 'Nachrichten',
  'comparison.messagesTitle': 'Agenten-Nachrichten / Ihre Nachrichten',
  'comparison.questions': 'Fragen',
  'comparison.tools': 'Tools',
  'comparison.errors': 'Fehler',
  'comparison.tokens': 'Tokens',
  'comparison.tokensTitle': 'Eingabe- / Ausgabe-Tokens',
  'comparison.sessions': 'Sitzungen',
  'comparison.duration': 'Dauer',
  'comparison.exportCsv': 'Als CSV exportieren',
  'comparison.open': 'Öffnen',
  'comparison.current': 'Dieser',
  'comparison.archived': 'archiviert',
  'comparison.incomplete':
    'Es existiert nur ein Workspace dieses Vergleichs. Der andere wurde nie erstellt oder wurde gelöscht.',
  'createPage.comparisonPartial':
    'Es wurden nur {count} von {total} Workspaces erstellt. Der vorhandene ist für sich nutzbar; löschen Sie ihn, wenn Sie neu anfangen möchten.',
  ...
  'createPage.importPr': 'Aus einem PR importieren',
  'createPage.importPrRequiresProject': 'Zuerst ein Projekt auswählen',
  'createPage.importPrNotSupported': 'Die Forge dieses Projekts unterstützt das Auflisten von Pull Requests nicht',
  'createPage.lockedToPr': 'Gesperrt auf PR #{number}',
  'createPage.prReadyToCreate': 'PR #{number} importiert — der Workspace kann erstellt werden.',
  'createPage.prResumeIntro': 'Weiterarbeit am bestehenden Pull Request #{number} "{title}" ({url}).',
  'createPage.unlockPrCheckout': 'Entsperren',
  ...
  'workflow.title': 'Git-Arbeitsablauf',
  'workflow.hint':
    'Diese Einstellungen steuern Agenten, ersetzen aber keine Systemberechtigungen. Strengere Nutzeranweisungen haben Vorrang. Veröffentlichen erlaubt kein Zusammenführen. Neue Arbeitsbereiche speichern diese Auswahl.',
  'workflow.commit': 'Commits erstellen',
  'workflow.push': 'Branch pushen',
  'workflow.publish': 'PR/MR oder Kommentare veröffentlichen',
  'workflow.manual': 'Manuell — ausdrücklicher Auftrag',
  'workflow.automatic': 'Automatisch — bei Bedarf',
  'workflow.inherit': 'Übernehmen',
  'workflow.locked':
    'Stoppe den Agenten, um diese Einstellungen zu ändern. Die laufende Sitzung hat sie bereits erhalten.',
  'workflow.updateFailed':
    'Die Einstellung konnte nicht gespeichert werden. Prüfe die Verbindung und versuche es erneut.',
  'workflow.save': 'Git-Einstellungen speichern',
  'workflow.saved': 'Git-Einstellungen gespeichert.',
  'workflow.planExecution':
    'Plan erlaubt die Vorbereitung. Wählen Sie für die Ausführung ausdrücklich einen geeigneten Berechtigungsmodus und setzen Sie die Schleife fort.',
  'settings.skillSuite.standard': 'Standard (ohne Erweiterungen)',
  'settings.skillSuite.standardHint': 'Integrierter Ablauf ohne externe Skills.',
  ...
  'settings.enableBrowserNotifications': 'Browser-Benachrichtigungen aktivieren',
  'settings.testBrowserNotification': 'Benachrichtigung testen',
  'settings.browserNotificationGranted': 'Browser-Benachrichtigungen erlaubt',
  'settings.browserNotificationDenied': 'Browser-Benachrichtigungen blockiert',
  'settings.browserNotificationAsk': 'Browser-Berechtigung erforderlich',
  'settings.browserNotificationUnsupported': 'Browser-Benachrichtigungen nicht verfügbar',
  'settings.browserNotificationPermissionNeeded': 'Erlaube Browser-Benachrichtigungen, um einen Test zu senden.',
  'settings.browserNotificationTestTitle': 'Kōbō-Benachrichtigungstest',
  'settings.browserNotificationTestBody': 'Browser-Benachrichtigungen funktionieren.',
  'settings.enableAudio': 'Audio aktivieren',
  'settings.notificationSound': 'Benachrichtigungston',
  'settings.notificationSoundHint': 'Wird abgespielt, wenn der Agent fertig ist oder eine Berechtigung anfordert.',
  'settings.questionSound': 'Frageton',
  'settings.questionSoundHint': 'Wird nur abgespielt, wenn der Agent eine Frage stellt.',
  'settings.workspaceCreatedSound': 'Ton für Workspace-Erstellung',
  'settings.workspaceCreatedSoundHint': 'Wird nach dem Erstellen eines Workspaces abgespielt.',
  'settings.notificationSoundPreview': 'Anhören',
  'settings.notificationVolume': 'Lautstärke',
  'settings.notificationSoundHey': 'Hey',
  'settings.agentErrorSound': 'Agentenfehler',
  'settings.agentErrorSoundHint': 'Wird bei Quoten-, Rate-Limit- und Agentenfehlern abgespielt.',
  'settings.notificationSoundBasic': 'Standardbenachrichtigung',
  'settings.notificationSoundWorkspaceCreated': 'Warcraft III — Arbeit',
  ...
  'settings.prSoundSection': 'PR / MR und CI',
  'settings.soundGeneral': 'Allgemeiner Ton',
  'settings.soundNone': 'Kein Ton',
  'settings.prCiFailedSound': 'CI fehlgeschlagen',
  'settings.prCiRecoveredSound': 'CI wieder erfolgreich',
  'settings.prChangesRequestedSound': 'Änderungen angefordert',
  'settings.prApprovedSound': 'PR genehmigt',
  'settings.prMergeConflictSound': 'Merge-Konflikt',
  'settings.prReadyToMergeSound': 'Bereit zum Mergen',
  'settings.prMergedSound': 'PR gemergt',
  'settings.prCiFailedSoundHint': 'Wird abgespielt, wenn die CI fehlschlägt.',
  'settings.prCiRecoveredSoundHint': 'Wird abgespielt, wenn sich die CI nach einem Fehler erholt.',
  'settings.prChangesRequestedSoundHint': 'Wird abgespielt, wenn Änderungen angefordert werden.',
  'settings.prApprovedSoundHint': 'Wird abgespielt, wenn der Pull Request genehmigt wird.',
  'settings.prMergeConflictSoundHint': 'Wird abgespielt, wenn ein Merge-Konflikt erkannt wird.',
  'settings.prReadyToMergeSoundHint': 'Wird abgespielt, wenn der Pull Request merge-bereit ist.',
  'settings.prMergedSoundHint': 'Wird abgespielt, wenn der Pull Request gemergt wird.',
  ...
  'settings.whipShortcutButtonLabel': 'Peitschen-Tastenkürzel: {shortcut}',
  'settings.whipShortcutRecordingLabel': 'Peitschen-Tastenkürzel wird aufgezeichnet. Tastenkürzel drücken…',
  'settings.whipShortcutReset': 'Tastenkürzel zurücksetzen',
  'settings.whipShortcutReserved': 'Dieses Tastenkürzel ist vom Browser reserviert.',
  'settings.testIntegration': 'Verbindung testen',
  'pwa.offline': 'Du bist offline. Chat und Agenten benötigen den Kōbō-Server.',
  'pwa.reconnecting': 'Verbindung zum Kōbō-Server wird wiederhergestellt…',
  'pwa.installReady': 'Kōbō als App installieren.',
  'pwa.install': 'Installieren',
  'pwa.ignore': 'Ignorieren',
  ...
  'settings.finalizationPromptTemplate': 'Auto-Loop-Finalisierungs-Prompt',
  'settings.finalizationPromptHint':
    'Standard-Prompt für die letzte Auto-Loop-Iteration (abschließende Qualitätsprüfungen). Wird verwendet, wenn ein Projekt seinen eigenen Finalisierungs-Prompt leer lässt.',
  ...
  'settings.hook.sessionEndedTitle': 'Hook: Sitzung beendet',
  'settings.hook.sessionEndedHint':
    'Läuft, wenn eine Agenten-Sitzung endet, aus welchem Grund auch immer. Liest KOBO_SESSION_END_REASON (completed / error / killed / watchdog), KOBO_SESSION_STOP_CAUSE, KOBO_AUTOLOOP_ACTIVE, KOBO_SESSION_ID und KOBO_SESSION_EXIT_CODE. Leer = deaktiviert.',
  'settings.hook.sessionEndedPlaceholder': 'z. B. npm test oder einen Chat-Kanal benachrichtigen…',
  'settings.hook.prMergedTitle': 'Hook: PR gemergt',
  'settings.hook.prMergedHint':
    'Läuft, wenn ein PR als gemergt erkannt wird, bevor der Workspace archiviert oder bereinigt wird - der Worktree liegt noch auf der Platte. Liest KOBO_PR_NUMBER und KOBO_PR_URL. Leer = deaktiviert.',
  'settings.hook.prMergedPlaceholder': 'z. B. ein Deployment auslösen, ein Release taggen…',
  'settings.hook.autoLoopDisabledTitle': 'Hook: Auto-Loop gestoppt',
  'settings.hook.autoLoopDisabledHint':
    'Läuft bei jeder Deaktivierung des Auto-Loops, durch Kōbō oder durch Sie. Liest KOBO_AUTOLOOP_REASON (completed / stall / error / user-action / awaiting-clarification) und KOBO_TASKS_PENDING. Leer = deaktiviert.',
  'settings.hook.autoLoopDisabledPlaceholder': 'z. B. benachrichtigen, wenn die Schleife hängt…',
  ...
  'settings.fileManagerCommand': 'Dateimanager-Befehl',
  ...
  'help.status.partial': 'teilweise',
  'help.status.seen': 'gesehen',
  'help.replayThis': 'Tour dieses Bildschirms wiederholen',
  'tours.next': 'Weiter',
  'tours.prev': 'Zurück',
  'tours.done': 'Fertig',
  'tours.exitConfirm':
  ...
  'tours.home.list.description':
    'Jede Mission lebt hier mit ihrem Status. Badges markieren eine fehlgeschlagene CI, ein Review mit Änderungswünschen oder einen merge-bereiten PR.',
  'tours.home.create.title': 'Workspace erstellen',
  'tours.home.create.description':
    'Ein Workspace ist ein Git-Worktree, ein Branch und eine Agent-Session für eine Aufgabe.',
  'tours.home.search.title': 'Suche',
  'tours.home.search.description':
    'Filtere die Liste nach Namen. Das Suchsymbol oben öffnet die Volltextsuche in den Agent-Gesprächen.',
  'tours.home.dashboard.title': 'Übersicht',
  'tours.home.dashboard.description':
    'Eine Tabelle für alle aktiven Workspaces: Status, Aufmerksamkeit, PR, Diff, Aktivität sowie die Zuverlässigkeit der Engines.',
  'tours.home.health.title': 'Status und Changelog',
  'tours.home.health.description':
    'Prüfe Datenbank, Runtimes und aktive Agents. Der Button daneben listet, was sich in jeder Version geändert hat.',
  'tours.home.settings.title': 'Einstellungen',
  'tours.home.settings.description':
    'Engines, Integrationen, Automatisierung, Worktrees und Projekte. Erstelle jetzt deinen ersten Workspace.',
  'tours.create.title': 'Einen Workspace erstellen',
  'tours.create.project.title': 'Projekt und Branch',
  'tours.create.project.description': 'Wähle das Projekt und den Branch, von dem der Worktree ausgeht.',
  'tours.create.mission.title': 'Mission',
  'tours.create.mission.description':
    'Beschreibe die Aufgabe oder importiere sie aus einer Notion-Seite oder einem Sentry-Issue.',
  'tours.create.template.title': 'Templates',
  'tours.create.template.description':
    'Wende ein gespeichertes Preset an oder speichere dieses Formular als Preset. „Duplizieren“ auf einer Workspace-Karte öffnet dieses Formular vorausgefüllt.',
  'tours.create.engine.title': 'Engine und Modell',
  'tours.create.engine.description':
    'Claude Code oder Codex, das Modell, der Reasoning-Aufwand und was der Agent ohne Nachfrage tun darf.',
  'tours.create.brainstorm.title': 'Brainstorm auf einem anderen Modell',
  ...
  'tours.workspace.input.title': 'Mit dem Agenten sprechen',
  ...
  'tours.workspace.git.description': 'Commits, Diff, Push, Rebase und der PR dieses Branches.',
  'tours.workspace.tasks.title': 'Aufgaben',
  'tours.workspace.tasks.description': 'Was der Agent vorhat, und die Akzeptanzkriterien, die er erfüllen muss.',
  'tours.workspace.timeline.title': 'Zeitachse',
  'tours.workspace.timeline.description': 'Jede Session dieses Workspaces; öffne eine ältere, um sie nachzulesen.',
  'tours.workspace.subagents.title': 'Sub-Agents',
  'tours.workspace.subagents.description':
    'Verfolge die Sub-Agents, die der Agent gestartet hat, mit ihrem Live-Fortschritt.',
  'tours.workspace.documents.title': 'Dokumente',
  'tours.workspace.documents.description':
  ...
  'tours.gitPr.panel.description': 'CI-Ergebnis, Review-Entscheidung und Reviewer, alle 30 Sekunden aktualisiert.',
  'tours.gitPr.actions.title': 'Git-Aktionen',
  'tours.gitPr.actions.description':
    'Push, Pull, Rebase oder Basis-Branch wechseln. Bei einem Konflikt lässt ein Button den Agenten ihn lösen.',
  'tours.gitPr.attention.title': 'Aufmerksamkeits-Badges',
  'tours.gitPr.attention.description':
    'Die Karte zeigt eine fehlgeschlagene CI, angeforderte Änderungen oder einen merge-bereiten PR.',
  'tours.settings.title': 'Einstellungen',
  'tours.settings.engines.title': 'Engines und Modelle',
  'tours.settings.engines.description': 'Standardmodelle, Berechtigungen und Grenzen für automatische Wiederholungen.',
  'tours.settings.integrations.title': 'Integrationen',
  'tours.settings.integrations.description':
    'Notion- und Sentry-Verbindungen sowie Bitbucket-Zugangsdaten. GitHub und GitLab verwenden Ihre lokale CLI-Anmeldung.',
  'tours.settings.automation.title': 'Automatisierung',
  'tours.settings.automation.description':
    'Setup- und Cleanup-Skripte, Lifecycle-Hooks, Prompt-Templates, Workspace-Templates und Skills.',
  'tours.settings.worktrees.title': 'Worktrees',
  'tours.settings.worktrees.description':
    'Wo Worktrees liegen, wie lange gemergte behalten werden, und das automatische Löschen.',
  'tours.settings.projects.title': 'Projekte',
  'tours.settings.projects.description': 'Registrierte Projekte und ihre projektspezifischen Überschreibungen.',
  'tours.settings.misc.title': 'Allgemein, Stimme, Benachrichtigungen, Export',
  'tours.settings.misc.description':
    'Sprache, Netzwerkzugriff, Diktat, Töne und Browser-Benachrichtigungen sowie ein vollständiger Export deiner Einstellungen.',
  'tours.dashboard.title': 'Übersicht',
  'tours.dashboard.overview.title': 'Überblick',
  'tours.dashboard.overview.description':
    'Alle aktiven Workspaces in einer Tabelle; klicke auf eine Zeile, um sie zu öffnen.',
  'tours.dashboard.reliability.title': 'Zuverlässigkeit der Engines',
  'tours.dashboard.reliability.description': 'Sessions, Fehler und Dauern pro Engine und Modell.',
  'tours.health.title': 'Status',
  'tours.health.checks.title': 'Prüfungen',
  'tours.health.checks.description': 'Umgebung, Datenbank, Runtimes, Workspaces und Sessions.',
  'tours.health.active.title': 'Aktiver Zustand',
  'tours.health.active.description': 'Aktuelle Quota-Back-offs, ausstehende Wake-ups und laufende Auto-Loops.',
  'tours.search.title': 'Suche',
  'tours.search.input.title': 'Suchanfrage',
  'tours.search.input.description': 'Findet Workspace-Namen und Agent-Gespräche.',
  'tours.search.archived.title': 'Archiviert',
  'tours.search.archived.description': 'Archivierte Workspaces in die Ergebnisse einbeziehen.',
  'tours.changelog.title': 'Was ist neu',
  'tours.changelog.list.title': 'Versionen',
  'tours.changelog.list.description': 'Was sich in jeder Version geändert hat, neueste zuerst.',
  ...
  'settings.bitbucketCommunityHint': 'Zugangsdaten bleiben lokal und werden nur von bkt verwendet.',
  'settings.bitbucketUsername': 'Atlassian-E-Mail',
  ...
  'settings.help.general': 'Sprache, Netzwerkzugriff und die Standardwerte, die jedes Projekt erbt.',
  'settings.help.agents': 'Standardmodelle und Berechtigungen sowie Grenzen für automatische Wiederholungen.',
  'settings.help.skills': 'Welche Skill-Suiten der Agent verwenden soll.',
  'settings.help.prompts':
    'Agentenanweisungen nach dem Öffnen einer PR/MR, für Code-Reviews, CI-Korrekturen und Abschluss.',
  'settings.help.scripts': 'Setup-, Cleanup- und Change-Source-Branch-Skripte sowie Lifecycle-Hooks.',
  'settings.help.notion': 'Eine Notion-Seite als Source of Truth eines Workspace importieren.',
  'settings.help.sentry': 'Einen Workspace aus einem Sentry-Issue erstellen.',
  'settings.help.forge':
    'Bitbucket-Zugangsdaten. GitHub und GitLab verwenden Ihre angemeldete gh/glab-CLI; wählen Sie die Forge pro Projekt.',
  'settings.help.voice': 'Diktat und Push-to-Talk.',
  'settings.help.notifications': 'Töne, Browser-Benachrichtigungen und die Erinnerung an unbeantwortete Fragen.',
  'settings.help.worktrees': 'Wo Worktrees angelegt werden, Aufbewahrung und automatisches Löschen.',
  'settings.help.projects': 'Registrierte Projekte und ihre projektspezifischen Überschreibungen.',
  'settings.help.templates': 'Prompt-Vorlagen, die in der Chat-Eingabe expandiert werden.',
  'settings.help.workspaceTemplates': 'Gespeicherte Voreinstellungen des Erstellungsformulars.',
  'settings.help.export': 'Alle Einstellungen als JSON exportieren und importieren.',
  ...
  'templates.resetToDefault': 'Auf Standard zurücksetzen',
  'templates.resetConfirmTitle': 'Template auf Standard zurücksetzen?',
  'templates.resetConfirmMessage':
    'Dies überschreibt deine lokalen Änderungen an /{slug} mit dem Standard. Kann nicht rückgängig gemacht werden.',
  'templates.resetSuccess': 'Template /{slug} auf Standard zurückgesetzt',
  'templates.resetFailed': 'Zurücksetzen des Templates fehlgeschlagen',
  ...
  'git.commits.diffThisCommit': 'Diff dieses Commits (vs Parent)',
  ...
  'git.workingTreeEmpty': 'Keine nicht committeten Änderungen',
  'git.fileStaged': 'Bereitgestellt',
  'git.fileModified': 'Geändert',
  'git.fileUntracked': 'Nicht verfolgt',
  'git.push': 'Push',
  ...
  'git.merge': 'Merge',
  'git.fetch': 'Fetch',
  'git.fetchSuccess': 'Repository abgerufen',
  'git.fetchFailed': 'Fetch fehlgeschlagen: {error}',
  ...
  'git.commitFailed': 'Commit fehlgeschlagen',
  'git.commitChanges': 'Änderungen committen',
  'git.commitDialogTitle': 'Nicht committete Änderungen committen',
  'git.commitDialogDescription':
    'Geben Sie Ihre Nachricht ein oder bitten Sie den Agenten, den Commit zu prüfen und zu erstellen.',
  'git.commitMessage': 'Commit-Nachricht',
  'git.commitManual': 'Committen',
  'git.commitWithAgent': 'Agenten fragen',
  'git.commitAgentSuccess': 'Commit-Anfrage an den Agenten gesendet',
  ...
  'git.dirtyTitleRebase': 'Nicht committete Änderungen blockieren den Rebase',
  'git.dirtyTitleMerge': 'Nicht committete Änderungen blockieren den Merge',
  'git.dirtyTitlePull': 'Nicht committete Änderungen blockieren den Pull',
  'git.dirtySubtitle':
    '{modified} geändert, {staged} bereitgestellt, {untracked} nicht verfolgt. Wähle, wie es weitergeht.',
  'git.dirtyStash': 'Stash & erneut versuchen',
  'git.dirtyCommit': 'Commit zuerst',
  'git.dirtyCommitPlaceholder': 'Commit-Nachricht',
  'git.dirtyCommitConfirm': 'Commit & erneut versuchen',
  'git.dirtyDiscard': 'Änderungen verwerfen',
  'git.dirtyDiscardConfirmTitle': 'Alle nicht committeten Änderungen verwerfen?',
  'git.dirtyDiscardConfirmMessage':
    'Verfolgte Änderungen gehen verloren (git reset --hard). Nicht verfolgte Dateien bleiben erhalten. Nicht umkehrbar.',
  ...
  'git.mergeRequest': '{request} mergen',
  'git.mergeRequestConfirmTitle': '{request} mergen?',
  'git.mergeRequestConfirmMessage': 'Dadurch wird die offene {request} in ihren Zielbranch gemergt.',
  'git.mergeRequestSuccess': '{request} gemergt',
  'git.mergeRequestFailed': '{request} konnte nicht gemergt werden',
  'git.deleteRemoteBranch': 'Remote-Branch löschen',
  'git.deleteRemoteBranchTitle': 'Remote-Branch löschen?',
  'git.deleteRemoteBranchMessage': 'Die Anfrage wurde gemergt. Remote-Branch {branch} löschen?',
  'git.deleteRemoteBranchSuccess': 'Remote-Branch {branch} gelöscht',
  'git.deleteRemoteBranchFailed': 'Remote-Branch konnte nicht gelöscht werden',
  ...
  'git.changeSourceBranchErrorTitle': 'Quellbranch-Wechsel fehlgeschlagen',
  'git.changeSourceBranchErrorOngoing':
    'Eine {op}-Operation läuft noch im Worktree. Brich sie ab, um zu einem sauberen Zustand zurückzukehren.',
  'git.changeSourceBranchErrorAbort': 'Operation abbrechen',
  ...
  'toast.prReadyToMerge': 'PR #{n} ist bereit zum Mergen',
  'toast.prCiFailed': 'CI für PR #{n} ist fehlgeschlagen',
  'toast.prCiRecovered': 'CI für PR #{n} ist wieder erfolgreich',
  'toast.prMergeConflict': 'PR #{n} hat Merge-Konflikte',
  'toast.prMerged': 'PR #{n} wurde gemergt',
  ...
  'diff.compareTo': 'Bis',
  'diff.compareSubmit': 'Vergleichen',
  'diff.compareSourceBase': '{branch} (Branch-Basis)',
  'diff.commitsReadOnly': 'schreibgeschützt',
  ...
  'notification.awaitingReminder': '{name} - wartet weiterhin auf Sie ({minutes} Min.)',
  ...
  'notification.autoLoopWaitingForSlot':
    '{name} - Auto-Loop wartet auf einen freien Agenten-Slot ({running}/{limit} aktiv)',
  ...
  'contextMenu.purgeWorktreeDialogTitle': 'Speicherplatz freigeben?',
  'contextMenu.purgeWorktreeDialogMessage':
    'Der Worktree-Ordner von „{name}" wird von der Festplatte gelöscht. Chat- und Sitzungsverlauf bleiben erhalten. Der Workspace wird automatisch archiviert. In der aktuellen Version nicht rückgängig zu machen.',
  'contextMenu.purgeWorktreeDialogConfirm': 'Worktree löschen',
  'contextMenu.purgeWorktreeSuccess': 'Worktree gelöscht — Speicherplatz zurückgewonnen.',
  'settings.autoPurgeOnPrMerged': 'Worktree automatisch löschen, wenn PR gemerged',
  'settings.autoPurgeOnPrMergedHint':
    'Wenn aktiviert, wird der Worktree von der Festplatte gelöscht, sobald die PR gemerged wird (zusätzlich zur automatischen Archivierung). Chat-Verlauf bleibt erhalten.',
  'settings.autoLoopMaxRetries': 'Maximale automatische Wiederholungen',
  'settings.awaitingUserReminder': 'Erinnerung an unbeantwortete Frage',
  'settings.awaitingUserReminderHint':
    'Minuten, die ein Workspace auf Ihre Antwort warten darf, bevor Kōbō Sie erinnert, danach in jedem weiteren Intervall. 0 deaktiviert.',
  'settings.localeLoadFailed': 'Diese Sprache konnte nicht geladen werden; die aktuelle bleibt aktiv.',
  'settings.autoLoopMaxRetriesHint':
    'Pausiert den Auftrag nach dieser Anzahl vorübergehender Engine- oder Serverfehler. Kontingente warten auf ihre Zurücksetzung und zählen nicht zu diesem Limit.',
  ...
  'settings.purgeDocsPermissionsRecoverTitle':
    'Einen bereits blockierten Worktree entsperren (bestehende root-eigene Dateien)',
  'settings.purgeDocsPermissionsRecoverIntro':
    'Wenn ein Worktree bereits voll mit root-eigenen Dateien ist (Docker hat schon gelaufen, vendor / node_modules sind blockiert), reicht die präventive ACL oben nicht — du musst die BESTEHENDEN Dateien behandeln. Zwei Ansätze, beide aus dem Worktree-Ordner heraus auszuführen:',
  'settings.purgeDocsPermissionsRecoverAclIntro':
    'Option A — Rekursive ACL (behält root-Ownership für Audit, fügt nur Zugriff für deinen Benutzer parallel hinzu):',
  'settings.purgeDocsPermissionsRecoverAclCommand':
    '# setze Default-ACL für zukünftige Dateien UND gewähre Zugriff auf alles Bestehende\n  sudo setfacl -Rd -m u:$(whoami):rwX . && sudo setfacl -R -m u:$(whoami):rwX .',
  'settings.purgeDocsPermissionsRecoverChownIntro':
    'Option B — Ownership übernehmen (einfacher, verliert die Spur "von root im Container erstellt", spielt in der Praxis selten eine Rolle):',
  'settings.purgeDocsPermissionsRecoverChownCommand': '  sudo chown -R $(whoami):$(whoami) .',
  'settings.purgeDocsPermissionsRecoverFootnote':
    'Tipp: Du kannst diese Befehle direkt auf das Worktrees-Root anwenden (z. B. `~/.worktrees/`), um alle bestehenden UND zukünftigen Workspaces auf einmal abzudecken. Danach funktioniert die Kōbō-Bereinigung ohne Berechtigungsfehler.',
  'contextMenu.runSetup': 'Setup-Skript ausführen',
  'contextMenu.exportEvents': 'Events exportieren (CSV)',
  'contextMenu.dismissChangesRequested': 'Änderungen angefragt als gesehen markieren',
  'contextMenu.dismissCiFailure': 'CI-Fehler als gesehen markieren',
  'contextMenu.restoreChangesRequested': 'Änderungen angefragt als ungesehen markieren',
  'contextMenu.restoreCiFailure': 'CI-Fehler als ungesehen markieren',
  ...
  'settings.network.copied': 'Kopiert',
  'settings.network.regenerate': 'Neu generieren',
  'settings.network.regenerateConfirm': 'Token neu generieren? Verbundene Geräte benötigen das neue Token.',
  'settings.network.urls': 'LAN-URLs',
  'settings.network.scan': 'Zum Verbinden scannen',
  ...
  'session.endedCompleted': 'Zug beendet — senden Sie eine Nachricht, um fortzufahren',
  'session.endedKilled': 'Sitzung gestoppt',
  'session.endedError': 'Sitzung mit einem Fehler beendet',
  ...
  'activity.a11y.region': 'Ansagen zur Agentenaktivität',
  'activity.a11y.agentSaid': 'Agent: {text}',
  'activity.a11y.toolStarted': 'Werkzeug {name} gestartet',
  'activity.a11y.toolFinished': 'Werkzeug {name} beendet',
  'activity.a11y.toolFailed': 'Werkzeug {name} fehlgeschlagen',
  ...
  'chat.scriptComplete': '[{phase}] Abgeschlossen',
  'chat.scriptError': '[{phase}] Fehler: {message}',
  'chat.unknownError': 'unbekannt',
  'chat.you': 'Du',
  ...
  'schedule.admissionTitle': 'Neue automatische Sitzung derzeit nicht verfügbar.',
  'schedule.admissionHint': 'Termine bleiben unverändert. Nachrichten in bestehenden Gesprächen folgen eigenen Regeln.',
  'schedule.admission.not-found': 'Arbeitsbereich nicht gefunden.',
  'schedule.admission.archived': 'Arbeitsbereich archiviert.',
  'schedule.admission.purged': 'Stellen Sie den Worktree wieder her.',
  'schedule.admission.shutdown': 'Server wird heruntergefahren.',
  'schedule.admission.lifecycle': 'Ein Arbeitsbereichsvorgang läuft.',
  'schedule.admission.active-session': 'Die aktuelle Sitzung ist noch nicht geschlossen.',
  'schedule.admission.awaiting-user': 'Eine Nutzerantwort ist erforderlich.',
  'schedule.admission.compacting': 'Kontext wird komprimiert.',
  'schedule.admission.quota': 'Warten auf Kontingentfreigabe.',
  'schedule.admission.blocked': 'Auto-Loop blockiert; beheben Sie die angezeigte Ursache.',
  'schedule.admission.capacity': 'Parallelitätslimit erreicht: {running}/{limit} Sitzungen.',
  'schedule.panelTitle': 'Automatisierung',
  'schedule.panelDescription': 'Diesen Workspace später wecken oder Anweisungen nach Zeitplan ausführen.',
  'schedule.activeTitle': 'Aktive Zeitpläne',
  'schedule.emptyTitle': 'Nichts geplant',
  'schedule.emptyDescription': 'Unten ein einmaliges Wakeup oder eine wiederkehrende Aufgabe erstellen.',
  'schedule.cancelWakeup': 'Dieses Wakeup abbrechen',
  'schedule.cancelCron': 'Diese wiederkehrende Aufgabe löschen',
  'schedule.createTitle': 'Zeitplan erstellen',
  'schedule.createDescription': 'Festlegen, wann und wie der Agent ausgeführt werden soll.',
  'schedule.typeWakeup': 'Einmaliges Wakeup',
  'schedule.typeRecurring': 'Wiederkehrende Aufgabe',
  'schedule.wakeupDescription': 'Den Prompt einmalig nach einer Verzögerung ausführen.',
  'schedule.cronDescription': 'Den Prompt regelmäßig nach einem festen Zeitplan ausführen.',
  'schedule.promptHint': 'Anweisungen, die an den Agenten gesendet werden',
  'schedule.frequencyTitle': 'Häufigkeit',
  'schedule.advancedDescription': 'Einen rohen Cron-Ausdruck verwenden',
  'schedule.cronExpressionLabel': 'Cron-Ausdruck',
  'schedule.sessionModeTitle': 'Ausführungssitzung',
  'schedule.modeResume': 'Sitzung fortsetzen',
  'schedule.oneShotHint': 'Diesen Zeitplan nach der ersten Ausführung entfernen.',
  ...
  'schedule.addWakeupTitle': 'Wakeup planen',
  'schedule.every': 'Alle',
  ...
  'schedule.labelOptional': 'Bezeichnung (optional)',
  'schedule.delayMinutes': 'Verzögerung (Minuten)',
  'schedule.modeFresh': 'Neue Sitzung',
  'schedule.oneShot': 'Nur einmal ausführen',
  'schedule.addCronBtn': 'Cron hinzufügen',
  'schedule.addWakeupBtn': 'Wakeup planen',
  'schedule.cronCreated': 'Wiederkehrende Aufgabe hinzugefügt',
  'schedule.wakeupCreated': 'Wakeup geplant',
  ...
  'askUserQuestion.freeFormLabel': 'Antwort präzisieren',
  'askUserQuestion.freeFormHint': 'Diese Antwort wird direkt an den Agenten gesendet.',
  ...
  'workspaceList.attentionReadyToMerge': 'Bereit zum Mergen',

  // Auto-loop
  'autoLoop.status.active': 'Aktiv',
  'autoLoop.status.waiting': 'Wartend',
  'autoLoop.status.blocked': 'Blockiert',
  'autoLoop.status.completed': 'Abgeschlossen',
  'autoLoop.status.stopped': 'Gestoppt',
  'autoLoop.phase.grooming': 'Vorbereitung',
  'autoLoop.phase.execution': 'Ausführung',
  'autoLoop.phase.finalization': 'Abschluss',
  'autoLoop.iteration': 'Durchlauf {count}',
  'autoLoop.resume': 'Auto-loop fortsetzen',
  'autoLoop.retryAt': 'Fortsetzung geplant für',
  'autoLoop.actionFailed': 'Die Aktion konnte nicht abgeschlossen werden.',
  'autoLoop.messages.count': '{count} Anweisung(en) in der Warteschlange',
  'autoLoop.messages.pending': 'Wartend',
  'autoLoop.messages.dispatching': 'Wird gesendet',
  'autoLoop.messages.unknown': 'Zustellung unklar',
  'autoLoop.messages.delivered': 'Zugestellt',
  'autoLoop.messages.cancel': 'Anweisung abbrechen',
  'autoLoop.messages.acknowledge': 'Als empfangen markieren',
  'autoLoop.messages.retry': 'Erneut senden',
  'autoLoop.messages.unknownHelp':
    'Die Zustellung konnte nicht bestätigt werden. Prüfen Sie zuerst den Gesprächsverlauf. Erneutes Senden kann eine bereits empfangene Anweisung duplizieren.',
  'autoLoop.reason.quota': 'Warten auf das Kontingent des Anbieters.',
  'autoLoop.reason.transient': 'Fortsetzung nach einer vorübergehenden Unterbrechung.',
  'autoLoop.reason.awaiting-user': 'Warten auf Ihre Antwort.',
  'autoLoop.reason.capacity-or-lifecycle': 'Warten auf einen freien Agentenplatz.',
  'autoLoop.reason.message-delivery-unknown': 'Klären Sie vor der Fortsetzung die ungewisse Zustellung.',
  'autoLoop.reason.error': 'Die Schleife benötigt Ihre Aufmerksamkeit, bevor sie fortfahren kann.',
  'autoLoop.reason.stall': 'Kein Fortschritt erkannt. Prüfen Sie vor der Fortsetzung die letzte Sitzung.',
  'autoLoop.reason.awaiting-clarification': 'Vor der Fortsetzung ist eine Klärung erforderlich.',
  ...
  // Network login
  'network.login.title': 'Netzwerkzugriff',
  'network.login.description':
    'Dieses Kōbō benötigt ein Token, um über das Netzwerk gesteuert zu werden. Füge das in den Einstellungen auf dem Host angezeigte Token ein.',
  'network.login.tokenLabel': 'Token',
  'network.login.tokenPlaceholder': 'Token einfügen',
  'network.login.connect': 'Verbinden',
  'network.login.invalid': 'Ungültiges Token',
  'network.login.serverError': 'Serverfehler — bitte erneut versuchen.',
  ...
  'prCheckout.staleRetriesExhausted':
    'Der Repository-Status hat sich während der Anwendung deiner Auswahl immer wieder geändert. Schließe diesen Dialog und versuche es erneut über die Pull-Request-Auswahl.',

  // PR-Auswahl + Checkout-Assistent
  'prPicker.title': 'Aus einer Pull Request importieren',
  'prPicker.filterAll': 'Alle',
  'prPicker.filterMine': 'Meine',
  'prPicker.filterReviewRequested': 'Review angefragt',
  'prPicker.searchPlaceholder': 'Pull Requests durchsuchen…',
  'prPicker.loadMore': 'Mehr laden',
  'prPicker.empty': 'Keine offene Pull Request passt.',
  'prPicker.forkNotSupported': 'Diese PR stammt von einem Fork; Kōbō kann sie nicht auschecken.',
  'prPicker.loadFailed': 'Pull Requests konnten nicht geladen werden.',
  'prPicker.badge.workspaceExists': 'Bereits in Kōbō geöffnet',
  'prPicker.badge.worktreePresent': 'Worktree vorhanden',
  'prPicker.badge.localBranch': 'Lokaler Branch',
  'prPicker.badge.new': 'Neu',
  'prPicker.badge.draft': 'Entwurf',

  'prCheckout.title': 'Worktree vorbereiten',
  'prCheckout.apply': 'Anwenden',
  'prCheckout.cancel': 'Abbrechen',
  'prCheckout.retry': 'Erneut versuchen',
  'prCheckout.diagnoseFailed': 'Die Diagnose des Pull Requests ist fehlgeschlagen.',
  'prCheckout.resolveFailed': 'Die Auflösung des Pull-Request-Checkouts ist fehlgeschlagen.',
  'prCheckout.path.required': 'Gib einen Worktree-Pfad ein, der noch nicht existiert.',
  'prCheckout.workspace.restoreNotAvailable':
    'Das Wiederherstellen eines bereinigten Workspaces ist von hier aus noch nicht möglich. Lege den Worktree-Ordner auf der Festplatte neu an (z. B. mit `git worktree add`) — Kōbō verknüpft ihn innerhalb von etwa 30 Sekunden automatisch wieder.',
  'prCheckout.staleReloaded': 'Das Repository hat sich geändert; die Diagnose wurde aktualisiert.',
  'prCheckout.step.blocked': 'Fortfahren nicht möglich',
  'prCheckout.step.path': 'Worktree-Speicherort',
  'prCheckout.step.workspace': 'Bestehender Workspace',
  'prCheckout.step.worktree': 'Bestehende Worktree',
  'prCheckout.step.operation': 'Git-Vorgang läuft',
  'prCheckout.step.changes': 'Nicht committete Änderungen',
  'prCheckout.step.divergence': 'Lokaler Branch vs. origin',
  'prCheckout.workspace.activeHint': 'Ein Workspace namens „{name}" verfolgt diesen Branch bereits.',
  'prCheckout.workspace.open': 'Diesen Workspace öffnen',
  'prCheckout.workspace.continue': 'Mit einem anderen Pfad fortfahren',
  'prCheckout.workspace.unarchive': 'Entarchivieren und öffnen',
  ...
  'prCheckout.operation.cancel': 'Unangetastet lassen und hier stoppen',
  'prCheckout.changes.hint': '{modified} geändert, {staged} vorgemerkt, {untracked} unverfolgt.',
  ...
  'prCheckout.divergence.keep': 'Lokalen Stand beibehalten',
  'prCheckout.blocked.forgeUnavailable': 'Das Forge-CLI fehlt oder ist nicht authentifiziert.',
  'prCheckout.blocked.forkPr': 'Diese PR stammt von einem Fork; Kōbō kann sie nicht auschecken.',
  'prCheckout.blocked.headBranchDeleted': 'Der Branch existiert auf dem Remote nicht mehr.',
  'prCheckout.blocked.indexLock': 'Ein anderer Git-Prozess läuft gerade (index.lock ist vorhanden).',
  'prCheckout.blocked.pathOccupied': '{path} existiert bereits und ist keine Worktree.',
