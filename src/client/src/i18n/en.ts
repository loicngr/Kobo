export default {
  ...
  'tours.settings.engines.description': 'Default model, effort and permission mode per engine.',
  'tours.settings.integrations.title': 'Integrations',
  'tours.settings.integrations.description': 'Notion, Sentry and the forge (GitHub or GitLab) that provides PRs.',
  ...
  'settings.help.agents': 'Default model, effort and permission mode for each engine.',
  'settings.help.skills': 'Which skill suites the agent is told to use.',
  'settings.help.prompts': 'Reusable prompt text: PR description, review, CI fix, finalization.',
  ...
  'settings.help.forge': 'GitHub or GitLab CLI used for PRs and merge requests.',
