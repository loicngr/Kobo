export default {
  ...
  'onboarding.settings-sentry.description': 'Import an issue from Sentry as the source of truth for a workspace.',
  'onboarding.settings-forge.title': 'Forge',
  'onboarding.settings-forge.description':
    'Choose GitHub, GitLab or none per project. Kōbō drives your own gh / glab CLI — it ships no credentials.',
  ...
  'onboarding.firstWorkspace.title': 'Create your first workspace',
  'onboarding.firstWorkspace.description':
    'That is the whole point: one mission, one worktree, one agent. Open the creation page to get started.',
